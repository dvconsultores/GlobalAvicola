...
| **B** procesos faltantes | ~~`R-130`~~ **CERRADO** (tranche 1, `GA-REM-005-B`) · ~~`R-160`~~ ~~`R-159`~~ **CERRADOS** (tranche 2, `GA-REM-040-G`) · ~~`R-163`~~ ~~`R-162`~~ **CERRADOS** (tranche 3, `GA-REM-040-H`) · `R-135` (`OD-17`) · `R-161` · `R-136` · `R-140` · `R-142` · `R-143` · `R-144` · `R-147` · `R-148` · `R-152` · `R-153` · `R-154` · `R-156` · `GA-REM-021` (+ `H360-B01…B04`, `B13`) |
