...
| T7 | Commit C1 (gobernanza + RED) + push | T5,T6 | hash + local==remoto | ○ |
| T8 | Implementación mínima del formulario y detalle | T7 | diff | ○ |
| T9 | GREEN dirigido + gates completos | T8 | salidas; 273+n verdes | ○ |
| T10 | Commit C2 + push + despliegue | T9 | hash; bundle nuevo congelado | ○ |
| T11 | Fixtures runtime (actores/áreas/BU) | T10 | ledger | ○ |
| T12 | E2E-01…16 + regresiones | T11 | evidence runtime/red/capturas | ○ |
| T13 | Relectura SLA al cierre | T12 | notificaciones o PENDING_SCAN_WINDOW | ○ |
