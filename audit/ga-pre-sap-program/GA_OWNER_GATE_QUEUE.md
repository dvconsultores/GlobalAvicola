...
| `AOD-08` · `AOD-10` | Cierre/FCR y fórmulas KPI (Wave C) | T12 | **`DECIDED_ACTING` (provisional, 2026-09-15)** — opción mínima: corregir R-131+R-132 en micro-tranche `GA-REM-022`; R-133/R-134/R-141 aceptados-documentados. Ver `GA_OWNER_DECISION_AOD10_ACTING_WAVE_C.md` (**revisable por el propietario**) |
