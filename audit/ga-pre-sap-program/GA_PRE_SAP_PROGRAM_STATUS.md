...
| **T14 · Cutover operacional — GA-REQ-061** | **SPEC_READY · IMPLEMENTATION_NOT_STARTED** (`7a158d5`+docs) | Capacidad nueva transversal Pre-Go-Live (mandato 2026-09-14): `specs/GA-REQ-061/` (11 docs; AC01-85; RED/sensibilidad/E2E/placement). Orden: T11 → **T14** → T12 → T13. `T10_BLOCKED_BY_CUTOVER = NO` |
