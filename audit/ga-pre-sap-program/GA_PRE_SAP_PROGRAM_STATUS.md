...
| T8 · Auditoría y evidencias (P1-12-REOPEN · R-198 · R-219) | **CLOSED_TECHNICALLY** (`45acbf8`, 2026-09-14) | Productor único con guarda compartida (`0bbad13`/`0de63c2`; BE 8/8; regresión 207/207; arnés runtime en módulos de conteo); evidencias del detalle + gate + borrado tras commit (`244ab43`; BE 7/7 + 122/122; FE 394/394); `AuditPage` contra el contrato real (`2f5d52f`; FE 5/5 + 399/399 + tsc 0); C2s por spec; **suite BE «PENDING»** (`evidence/t8/…`) ⇒ `GA_T8_CERTIFICATION.md`. **P-02/P-09 reparados técnicamente**; C3 runtime en ventana (G-06) |
