...
| P6 | Commit C1 (gobernanza + RED, sin producto) — `de79235` | ✅ |
| P7 | Implementación (serializador · mapeo OC · normalizador seguro) — `5992ddc` | ✅ |
| P8 | GREEN dirigido + suite completa + tsc + build | ✅ |
| P9 | Commit C2 + deploy + generación nueva — C2d `38d4647` ⇒ `index-BwuucRxo.js` | ✅ |
| P10 | E2E-01…13 runtime + recertificación R-153 (addendum) — corridas A (C2d, RED F-01e) y B (C2f, retry 7/7) | ✅ |
| P11 | Evidencia + limpieza (fixture retenido al ledger) + C3 — `GA_F01_RUNTIME_CERTIFICATION.md` | ✅ |
| P12 | Walkthrough UAT-01…07 (retry) ✅ 7/7 · paquete C4 + §81 + pregunta al propietario | ⏳ (propietario) |
...
| 27-34 | T5 | — | suites R-153 (PG, CI) | E2E-06…10/12 + addendum | ✅ (retry UI 7/7) |
| 35-40 | T5 | — | E2E-13 | runtime | ✅ (superficie sin cambios; negativos admin-only declarados) |
| 41-47 | T6 | — | vitest/tsc/build + ES/EN + móvil | capturas | ✅ (`C08m`; sin strings nuevos) |
| 48-54 | T1 | — | — | paquete C1…C4 | ✅ (C4 ⏳ propietario) |
| 55-62 | F-01d | anexo `GA_F01D_SUBSANACION_ANNEX.md` | `f01d.serializers` + suite backend | runtime C2d/C2f | ✅ |
| 63-65 | F-01e | anexo `GA_F01E_SUBSANACION_ANNEX.md` | `f01e.receptionHouse` | runtime C2f | ✅ |
...
| T6 | C2 + deploy + E2E-01…13 + recertificación + evidencia + limpieza + C3 | `audit/ga-f01/**` | runtime | T5 | ✅ (C3 `GA_F01_RUNTIME_CERTIFICATION.md`) |
| T7 | Retry UAT-01…07 + paquete C4 + §81 | `audit/ga-r153/uat/**` | runtime | T6 | ✅ retry 7/7 · C4/§81 ⏳ (propietario) |
