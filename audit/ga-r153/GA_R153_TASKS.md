...
| T07 | C1 gobernanza + RED | `audit/ga-r153/**`, tests RED | — | T01 | ✅ `9651550` |
| T08 | C2 implementación + push | T02-T05 | — | T06 | ✅ `47ea484` + C2b `db8ae21` (derivación por tipo, AC58/59) |
| T09 | Deploy + E2E-01…16 + capturas | `scripts_e2e_r153.py` | — | T08 | ✅ |
| T10 | Limpieza + ledger + red saneada | `scripts_e2e_r153_cleanup.py` | — | T09 | ✅ (incl. incidente roles reparado — OBS-1) |
| T11 | Evidencia backend/frontend/concurrencia + reconciliación + certificación | `audit/ga-r153/**` | — | T09/T10 | ✅ |
| T12 | C3 evidencia + masters + UAT READY | — | — | T11 | ✅ (este commit) |
