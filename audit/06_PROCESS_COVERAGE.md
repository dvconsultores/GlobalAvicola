...
| Tipo (nombre literal) | Estado tras `OD-08` |
|---|---|
| Registro pendiente de revisión > 24h | **IMPLEMENTADO** — umbral normativo, medido desde la auditoría |
| Registro rechazado (notificar al operador) | **IMPLEMENTADO** — operador ∪ `OD-08` |
