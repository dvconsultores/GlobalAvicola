...
| FVA-19 | Lote automático de abuelas (CAP-BU-04) | Progenitoras | CERTIFIED_TECH · UAT PENDING | OD-25 (B) implementado: `L-GP-{año}-{nn}` al aprobar, sin poblar | `/operations` (import) | OperationForm/DetailPage | operations API + hook P-07 | PRODUCTIVE gp | sí | sí | operations:create | ✓ | ✓ (E2E) | ✓ | ✓ | ✓ |
