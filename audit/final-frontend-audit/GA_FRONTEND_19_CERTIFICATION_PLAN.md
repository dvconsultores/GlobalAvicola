...
| **CP** (Control lectura) | FVA-06 | docs/02 §3.2.1 (catálogo empresas) | admin de empresa | empresa 1 (1 fila) | suites masters | JSON + captura de listado | **NO** (lectura cubierta por flujos admin aceptados) |
