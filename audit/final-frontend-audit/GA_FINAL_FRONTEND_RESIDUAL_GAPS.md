...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RES-01 | FVA-07 (CAP-ADM-02) | Propiedad SAP vs local de Empresas/Granjas sin decidir (afecta reglas de alta/edición del maestro) | OWNER_DECISION_REQUIRED | **P1** (gobernanza de producto; «no bloquea fase 9»; antes de WAVE D) | Medio (metadatos maestros) | Ninguno | R-124 / AOD-06 | No | No | **SÍ** (sesión de decisión) | No | Sesión de decisión AOD-06 (gobernanza) |
...
| RES-03 | FVA-19 (CAP-BU-04) | Lote automático de abuelas «al completar importación» sin decisión (qué es completar/código/poblar) | OWNER_DECISION_REQUIRED | P3 | Bajo | Ninguno | R-153 / AOD-25 | No | No | **SÍ** (lista Wave B) | No | Decisión AOD-25 → SPEC si aplica |
