...
export default function LoginPage() {
 ...
 {/* Error */}
 {error && (
 <div className="flex items-center gap-2 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800/40 text-red-600 dark:text-red-400 px-3.5 py-2.5 rounded-xl text-xs font-medium">
 ...
 <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-300 dark:text-slate-500 pointer-events-none">
 <User size={15} />
 </span>
 <input
 id="login-username"
