...
export default function MasterListPage({
 ...
 <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{total} {t('common.results')}</p>
 </div>
 ...
 <span className="text-slate-500 dark:text-slate-400">{t('common.page')} {page + 1}</span>
