...
export default function LotFormPage() {
  ...
  const selectClass = 'w-full h-10 px-3 border border-slate-300 rounded-lg text-sm text-slate-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-[#2563EB] disabled:bg-slate-50 disabled:text-slate-400'
