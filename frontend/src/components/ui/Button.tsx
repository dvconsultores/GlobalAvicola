...
const VARIANT_CLASSES: Record<Variant, string> = {
  ...
  secondary:
    'bg-slate-100 dark:bg-dark-card text-slate-700 dark:text-slate-200 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 active:bg-slate-300 focus-visible:ring-slate-400 border border-slate-200 dark:border-dark-border',
  danger:
  ...
  outline:
    'bg-transparent border border-slate-200 dark:border-dark-border text-slate-700 dark:text-slate-200 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-dark-card active:bg-slate-100 focus-visible:ring-slate-400',
}
