...
export default function SignaturePad({
 ...
 return (
 <div className="border-2 border-dashed border-slate-300 rounded-xl p-3 bg-slate-50 dark:bg-slate-800">
 {label && (
 ...
 width={width}
 height={height}
 className="w-full bg-white dark:bg-slate-800 rounded-lg border border-slate-200 cursor-crosshair touch-none"
 ...
 type="button"
 onClick={handleClear}
 className="text-xs text-slate-500 dark:text-slate-400 hover:text-red-600 transition-colors"
 >
 ...
 type="button"
 onClick={onCancel}
 className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-800 bg-white dark:bg-slate-800 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors"
 >
