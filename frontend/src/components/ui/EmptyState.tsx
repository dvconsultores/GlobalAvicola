...
export default function EmptyState({
 ...
 <h3 className="text-sm font-bold text-slate-600 dark:text-slate-300 text-center mb-1">{title}</h3>
 {description && (
 <p className="text-xs text-slate-400 dark:text-slate-500 text-center max-w-sm mb-4">{description}</p>
 )}
 {action && (
 <button
