...
export default function MenuCard({
 ...
 ${isActive
 ? 'bg-blue-50 dark:bg-blue-950 dark:bg-blue-900/20 border-blue-500 shadow-lg shadow-blue-500/10'
 ...
 {/* Footer arrow */}
 <span className="mt-auto pt-3 inline-flex items-center gap-0.5 text-xs font-bold text-blue-600 group-hover:gap-1.5 transition-all">
