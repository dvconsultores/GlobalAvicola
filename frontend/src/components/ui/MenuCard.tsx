  ...
  return (
    <button
      ...
      className={`group relative flex flex-col items-start text-left p-5 rounded-2xl border-2 transition-all duration-200 active:scale-[0.98] hover:-translate-y-0.5
        ${isActive
          ? 'bg-blue-50 dark:bg-blue-950 dark:bg-blue-900/20 border-blue-500 dark:border-blue-400 shadow-lg shadow-blue-500/10'
          : 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:border-blue-700 dark:hover:border-blue-700 shadow-sm hover:shadow-md'
        }`}
    >
      {/* Step number badge */}
      {step !== undefined && (
      ...
      <span
        className={`inline-flex p-3 rounded-xl mb-4 transition-colors
          ${isActive
            ...
            : 'bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-100 group-hover:bg-blue-50 dark:bg-blue-950 dark:group-hover:bg-blue-900/30 group-hover:text-blue-600 dark:text-blue-400 dark:group-hover:text-blue-400'
          }`}
      >
      ...
      <h3
        className={`text-sm font-bold leading-tight mb-1
          ${isActive
            ? 'text-blue-700 dark:text-blue-300 dark:text-blue-400 dark:text-blue-300 dark:text-blue-400'
