...
export default function ConfirmDialog({
 ...
 onClick={onClose}
 disabled={loading}
 className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover hover:bg-slate-100 transition-colors disabled:opacity-50"
 ...
 onClick={onClose}
 disabled={loading}
 className="flex-1 h-11 rounded-lg border border-slate-300 text-sm font-semibold text-slate-700 hover:bg-slate-50:bg-slate-700 transition-colors disabled:opacity-50"
 >
